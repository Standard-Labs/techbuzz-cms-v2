...
export interface ApiAuthorAuthor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    officialEmail: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiDirectoryListingDirectoryListing
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'title'>;
    sponsored: Schema.Attribute.Boolean;
...
export interface ApiOpenDealOpenDeal extends Struct.CollectionTypeSchema {
  collectionName: 'open_deals';
  info: {
    description: '';
    displayName: 'Open Deals';
    pluralName: 'open-deals';
    singularName: 'open-deal';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiPodcastSeriePodcastSerie
  extends Struct.CollectionTypeSchema {
...
export interface ApiSocialSocial extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    embed: Schema.Attribute.RichText;
...
export interface ApiStandardTeamStandardTeam
  extends Struct.CollectionTypeSchema {
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::directory-listing.directory-listing': ApiDirectoryListingDirectoryListing;
      'api::directory.directory': ApiDirectoryDirectory;
      'api::global.global': ApiGlobalGlobal;
      'api::open-deal.open-deal': ApiOpenDealOpenDeal;
      ...
      'api::standard-team.standard-team': ApiStandardTeamStandardTeam;
